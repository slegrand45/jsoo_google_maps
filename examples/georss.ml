...
let demo doc =
  ...
  let center = new%js GM.latLng (Js.number_of_float 49.496675) (Js.number_of_float (-102.65625)) Js.undefined in
  ...
  in
  let georssLayer = new%js GM.kmlLayer (Js.def options) in
